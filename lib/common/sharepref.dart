class Sharepref {
  ...
  static String Generate_Token_Command = "generate_token_command";
  static final String APP_LAUNCH_TIME = "app_launch_time";
  static final String osVersion = "os_version";

  // Settings
  static String deviceName = "deviceName";
  static String settingName = "settingName";
  static String settingVersion = "settingVersion";
  ...
  static String enableVendorQR = "enableVendorQR";
  static String enableOfflineQRCode = "enableOfflineQRCode";
  static String enableVisitorQR = "enableVisitorQR";
  static String visitorMode = "visitorMode";
  static String enableVisitorCheckout = "enableVisitorCheckout";
